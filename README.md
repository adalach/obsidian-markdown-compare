...
2. Run the command `Compare two files`.
3. To remove highlighting, run `Clear compare highlights`.
4. To keep highlights updated while you edit, run `Toggle live compare`.
